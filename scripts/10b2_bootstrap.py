...
#
# Output:
#   outputs/10b_bootstrap_figures/
#       10b_fig1_forest_per_phase.png
#       10b_fig2_top10_bar.png
#       10b_fig3_svm_vs_rf_scatter.png
# ============================================================
...
OUT_DIR = os.path.join(OUTPUT_DIR, "10b_bootstrap_figures")
os.makedirs(OUT_DIR, exist_ok=True)

OUT_FIG1 = os.path.join(OUT_DIR, "10b_fig1_forest_per_phase.png")
OUT_FIG2 = os.path.join(OUT_DIR, "10b_fig2_top10_bar.png")
OUT_FIG3 = os.path.join(OUT_DIR, "10b_fig3_svm_vs_rf_scatter.png")
...
if not os.path.exists(IN_CSV):
    raise FileNotFoundError(
        ...
        "Run 10b_bootstrap_full.py first."
    )
...
for i, row in top.iterrows():
    ...
    # numeric value at bar end + CI in grey  (CI text always right of whisker)
    val_x = min(mean + 0.015, 0.97)
    ax.text(val_x, y, f"{mean:.2f}",
            va="center", ha="left",
            fontsize=11, fontweight="bold", color="black", zorder=5)
    ci_x = max(val_x + 0.075, hi + 0.025)
    ax.text(ci_x, y, f"[{lo:.2f}, {hi:.2f}]",
            va="center", ha="left",
